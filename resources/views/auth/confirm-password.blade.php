<x-guest-layout>
    <div class="text-center mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Confirmá tu contraseña</h1>
        <p class="text-sm text-gray-500 mt-1">Esta es un área segura. Confirmá tu contraseña antes de continuar.</p>
    </div>
